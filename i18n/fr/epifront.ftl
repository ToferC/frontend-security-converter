...
welcome-to = Welcome to the NATO Classification Converter MVP

## General Section

ncc = NATO Classification Converter
-app-name = NATO Classification Converter
app-description = { -app-name } is a learning project and experiment in metadata as middleware.
...
## Footer
footer-1 = Please note that this work is a learning project and experiment in developing security classification converter as middleware for NATO.
available-licence = The NATO Classification Converter project is available on GitHub under an MIT licence here:
developed-by = Developed by ToferC 2025-26
